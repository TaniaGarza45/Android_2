...
class Empresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Empresa venta de burritos'),
      ), //findeappbar
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('Venta de burritos'),
      ), //findeappbar
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.black, image: DecorationImage(image: NetworkImage('https://raw.githubusercontent.com/TaniaGarza45/Fotos/main/field_image_head-burrito.jpg'), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
